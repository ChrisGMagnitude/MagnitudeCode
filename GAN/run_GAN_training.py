...
batch_size = 56#32
num_workers = 8#40
description = 'GAN-Wasserstien-gp-Working4-noBN-hypreparamchange'
trainging_mode = 'all'#'all'#'generator'#'discriminator'
initial_weights = r'/mnt/magbucket/segmentation/Models/GAN-Wasserstien-gp-Working2-noBN - all - 2025-11-14 162303'#'default'#
