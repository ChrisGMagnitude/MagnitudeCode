...
batch_size = 56#32
num_workers = 8#40
description = 'GAN-Wasserstien-gp-Working2-noBN-fullDepth-Reboot-ncritic50'
trainging_mode = 'all'#'all'#'generator'#'discriminator'
initial_weights = '/mnt/magbucket/segmentation/Models/balanced - all - 2025-07-01 195347'#GAN-Wasserstien-gp-Working2-noBN - all - 2025-11-14 162303'#'default'#
initial_weights_file = 'last_model_params.pt'#'55_epoch_model_params.pt'#'last_model_params.pt'#'25_epoch_model_params.pt'#'default'#
initial_weights_d = 'default'#'/mnt/magbucket/segmentation/Models/GAN-Wasserstien-gp-Working2-noBN - all - 2025-11-14 162303'#r'/mnt/magbucket/segmentation/Models/GAN-fancyRound-head-Wasserstien-Working-Reboot - all - 2025-11-13 100007'#'default'#
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(ndf * 8, 1, 6, 1, 0, bias=True),
            nn.LeakyReLU(0.2, inplace=True)
