...
batch_size = 24#32
num_workers = 8#40
description = 'deeplabv3_resnet50-GAN-sigmoid'
trainging_mode = 'all'#'all'#'generator'#'discriminator'
initial_weights = r'/mnt/magbucket/segmentation/Models/deeplabv3_resnet50-GAN - discriminator - 2025-11-05 170550'#'default'#
initial_weights_file = '5_epoch_model_params.pt'#'default'#
initial_weights_d = r'/mnt/magbucket/segmentation/Models/deeplabv3_resnet50-GAN - discriminator - 2025-11-05 170550'#'default'#
initial_weights_file_d = '5_epoch_netD_params.pt'
lr_g = 0.0002
lr_d = 0.0002
momentum = 0.9
step_size = 10
