...
batch_size = 1#24#32
num_workers = 8#40
description = 'GAN-fancyRound-head-Wasserstien-Working-Reboot'
trainging_mode = 'all'#'all'#'generator'#'discriminator'
initial_weights = r'/mnt/magbucket/segmentation/Models/GAN-fancyRound-head-Wasserstien-Working-Reboot - all - 2025-11-13 100007'#'default'#
initial_weights_file = '25_epoch_model_params.pt'#'default'#
initial_weights_d = r'/mnt/magbucket/segmentation/Models/GAN-fancyRound-head-Wasserstien-Working-Reboot - all - 2025-11-13 100007'#'default'#
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(ndf*16, ndf*32, 4, 2, 0, bias=False),
