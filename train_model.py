...
batch_size = 40#32
num_workers = 40#40
description = 'Extended Classification Attempt'
trainging_mode = 'all'#'all'#'head'#'final-fc'#'first-conv'
initial_weights = r'/mnt/field/test/ml/cg/Classification Models/Extended Classification Attempt - all - 2025-03-12 172025'#'default'#
lr = 0.02#0.1
momentum = 0.9
step_size = 10
gamma = 0.5 # 0.6
...
train_dataset = MagClassDataset(r'/mnt/field/test/ml/cg/Classification Datasets/Extended Dataset 2/train.hdf5')
train_loader = get_weighted_data_loader(train_dataset,epoch_size_train,batch_size,num_workers=num_workers)

val_dataset = MagClassDataset(r'/mnt/field/test/ml/cg/Classification Datasets/Extended Dataset 2/valid.hdf5',augment=False)
